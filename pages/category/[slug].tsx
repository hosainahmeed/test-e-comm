...
export default function CategoryPage({ products, categoryName, total }: CategoryPageProps) {
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      ...
      <div style={{ marginBottom: '20px', fontSize: '14px', color: '#6b7280' }}>
        ...
        <Link href="/categories" style={{ color: '#3b82f6', textDecoration: 'none' }}>
          Categories
        </Link>
        <span style={{ margin: '0 8px' }}>/</span>
      ...
      <section style={{
        ...
        <h1 style={{ fontSize: '36px', marginBottom: '10px', textTransform: 'capitalize' }}>
          {categoryName}
        </h1>
