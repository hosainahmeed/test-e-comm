...
export default function ProductList() {
  ...
  if (products.length === 0) {
    return <div style={{ textAlign: 'center', padding: '40px' }}>No products found</div>
  }

  return (
    <div>
      <div 
        className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 space-y-6!'
      >
